...
dag = DAG(dag_id='CPU_stress_dag', description='CPU stress dag',
          schedule_interval='@once',
          start_date=datetime(2022, 4, 20), catchup=False)
...
start >>[CPU_stress_test,CPU_stress_test_1,CPU_stress_test_2, CPU_stress_test_3, CPU_stress_test_4, CPU_stress_test_5, CPU_stress_test_6]>> stop
